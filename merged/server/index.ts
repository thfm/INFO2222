...
// ---------------------------------------------------------------------------
// Server Authentication on Login (Phase 3, Task 1)
// The server runs over HTTPS (TLS 1.2+) so that the browser verifies the
// server certificate before transmitting any credentials.  Certificates are
// generated by generate-certs.sh in the repo root.
// ---------------------------------------------------------------------------
...
https.createServer(tlsOptions, app).listen(port, () => {
  ...
  console.log(`[contritrack] Running on https://localhost:${port}`);
  console.log(`[contritrack] TLS certificate: ${join(certsDir, 'server.crt')}`);
