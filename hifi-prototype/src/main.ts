...
import { showConsentModal } from './modals';
        ...
        <div class="app-header__right">
          ...
          <div class="header-user">
            ...
            <div class="header-user__info">
              <div class="header-user__name">${state.view === 'student' ? 'Alex Chen' : 'Tutor Hayes'}</div>
              <div class="header-user__role">${state.view === 'student' ? 'Student' : 'Tutor'}</div>
            </div>
          </div>
        </div>
      </header>
...
function init(): void {
  ...
  subscribe(() => {
    if (state.view !== prevView || state.isDarkMode !== prevDarkMode || state.flagCount !== prevFlagCount) {
      prevView = state.view;
