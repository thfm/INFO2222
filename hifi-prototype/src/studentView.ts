...
import { state, setState, addMessage, showBanner, subscribe, dismissBanner } from './state';
          ...
          <div class="student-main__body">
            ...
            <div class="chat-input-area">
              <div class="chat-input-wrap">
                ...
                <input type="text" id="chat-input" class="chat-input__field" placeholder="Message your group…" maxlength="500" />
